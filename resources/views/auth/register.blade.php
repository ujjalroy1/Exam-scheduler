            ...
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                ...
                <div class="mt-4">
                    ...
                    <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                         ...
                         <x-text-input id="faculty" class="block mt-1 w-full" type="text" name="faculty" :value="old('faculty')" required autocomplete="faculty" />
                ...
                <div class="mt-4">
                    ...
                    <x-input-error :messages="$errors->get('dept')" class="mt-2" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="session" class="block mt-1 w-full" type="text" name="session" :value="old('session')" required autocomplete="session" />
